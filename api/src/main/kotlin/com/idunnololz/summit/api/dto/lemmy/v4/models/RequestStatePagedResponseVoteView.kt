...
import com.idunnololz.summit.api.dto.lemmy.v4.models.SuccessRequestStatePagedResponseVoteView
...
data class RequestStatePagedResponseVoteView (

    @SerializedName("state")
    val state: RequestStatePagedResponseVoteView.State,

    @SerializedName("err")
    val err: Error,

    @SerializedName("data")
    val `data`: PagedResponseVoteView

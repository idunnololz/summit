...
class LemmyApiV3Adapter(
  ...
  override suspend fun getUnreadCount(
    ...
    val registrationApplications = registrationCount.registration_applications
    val commentReports = reportCount.comment_reports
    val postReports = reportCount.post_reports

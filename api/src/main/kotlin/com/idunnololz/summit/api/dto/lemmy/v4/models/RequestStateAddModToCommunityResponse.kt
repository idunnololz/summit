...
import com.idunnololz.summit.api.dto.lemmy.v4.models.SuccessRequestStateAddModToCommunityResponse
...
data class RequestStateAddModToCommunityResponse (

    @SerializedName("state")
    val state: RequestStateAddModToCommunityResponse.State,

    @SerializedName("err")
    val err: Error,

    @SerializedName("data")
    val `data`: AddModToCommunityResponse

...
class RateLimitException(
  val timeout: Long,
) : ClientApiException("Rate limit timed out.", 429)
class NewApiException(
 ...
 */
class SocketTimeoutException : NetworkException("Timed out waiting for server to respond")
...
class CommunityBlockedError :
  ClientApiException(
    "The community you are trying to access is blocked",
    400,
  )

class LanguageNotAllowed :
  ClientApiException(

...
import com.idunnololz.summit.inbox.message.MessageFragment
...
//            binding.viewPager.isUserInputEnabled = it.size > 1
    ...
    val slidingPaneController = SlidingPaneController(
      ...
      onPageSelectedListener = a@{ isOpen ->
        ...
        if (isOpen) {
          getMainActivity()?.setNavUiOpenPercent(0f, force = isSlideable)
          ...
          getMainActivity()?.setNavUiOpenPercent(1f, force = isSlideable)

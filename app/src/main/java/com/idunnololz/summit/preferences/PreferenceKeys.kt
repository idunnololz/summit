...
object PreferenceKeys {
  ...
  const val KEY_POST_UI_CONFIG_LIST2 = "KEY_POST_UI_CONFIG_LIST2"
  ...
  const val KEY_POST_UI_CONFIG_SMART_LIST = "KEY_POST_UI_CONFIG_SMART_LIST"
  ...
  const val KEY_STRING_FOR_NULL_SCORE = "KEY_STRING_FOR_NULL_SCORE"
  ...
  const val KEY_SHOW_DEFAULT_PROFILE_ICONS = "KEY_SHOW_DEFAULT_PROFILE_ICONS"
  ...
  const val KEY_WRAP_COMMENT_HEADER = "KEY_WRAP_COMMENT_HEADER"
  ...
  const val KEY_POSTS_IN_FEED_QUICK_ACTIONS = "KEY_POSTS_IN_FEED_QUICK_ACTIONS"
  ...
  const val KEY_AUTO_HIDE_UI_ON_PLAY = "KEY_AUTO_HIDE_UI_ON_PLAY"
  const val KEY_TAP_ANYWHERE_TO_PLAY_PAUSE = "KEY_TAP_ANYWHERE_TO_PLAY_PAUSE"
  const val KEY_OPEN_LINK_WHEN_THUMBNAIL_TAPPED = "KEY_OPEN_LINK_WHEN_THUMBNAIL_TAPPED"
  const val KEY_SHOW_POST_TYPE = "KEY_SHOW_POST_TYPE"
  ...
  const val KEY_NAV_RAIL_GRAVITY = "KEY_NAV_RAIL_GRAVITY"
  const val KEY_INLINE_URLS_IN_PRIVATE_MESSAGES = "KEY_INLINE_URLS_IN_PRIVATE_MESSAGES"
  const val KEY_SHOW_CROSS_POSTS_IN_POST = "KEY_SHOW_CROSS_POSTS_IN_POST"
  const val KEY_PERF_DELAY_WHEN_LOADING_DATA = "KEY_PERF_DELAY_WHEN_LOADING_DATA"
  const val KEY_LOOP_VIDEO_BY_DEFAULT = "KEY_LOOP_VIDEO_BY_DEFAULT"
  const val KEY_DO_NOT_BLUR_NSFW_CONTENT_IN_NSFW_COMMUNITY_FEED = "KEY_DO_NOT_BLUR_NSFW_CONTENT_IN_NSFW_COMMUNITY_FEED"
  const val KEY_PREFER_USER_DISPLAY_NAME = "KEY_PREFER_USER_DISPLAY_NAME"
  const val KEY_SHOW_BOT_LABEL = "KEY_SHOW_BOT_LABEL"
  const val KEY_SHOW_PRONOUNS_IF_AVAILABLE = "KEY_SHOW_PRONOUNS_IF_AVAILABLE"
  const val KEY_PREFER_COMMUNITY_DISPLAY_NAME = "KEY_PREFER_COMMUNITY_DISPLAY_NAME"
  ...
  const val KEY_RESTORE_BROWSING_SESSIONS = "KEY_RESTORE_BROWSING_SESSIONS"
  const val KEY_FINISH_APP_ON_BACK = "KEY_FINISH_APP_ON_BACK"
  const val KEY_SHOW_NAVIGATION_BAR_ON_POST = "KEY_SHOW_NAVIGATION_BAR_ON_POST"
  const val KEY_IMAGE_VIEWER_CONTROL_STYLE = "KEY_IMAGE_VIEWER_CONTROL_STYLE"
  ...
  const val KEY_HIDE_READ_BY_DEFAULT = "KEY_HIDE_READ_BY_DEFAULT"
  const val KEY_HIGHLIGHT_NEW_COMMENTS = "KEY_HIGHLIGHT_NEW_COMMENTS"
  const val KEY_USE_VOLUME_BUTTONS_ON_POST_FEED = "KEY_USE_VOLUME_BUTTONS_ON_POST_FEED"
  const val KEY_SAVE_RECENT_COMMUNITIES = "KEY_SAVE_RECENT_COMMUNITIES"
  const val KEY_LOCAL_TRACKING_ENABLED = "KEY_LOCAL_TRACKING_ENABLED"
  const val KEY_USE_CURSORS_WHEN_LOADING_POST_FEED = "KEY_USE_CURSORS_WHEN_LOADING_POST_FEED"
  const val KEY_COMMUNITY_SELECTOR_COMMUNITIES_LIST = "KEY_COMMUNITY_SELECTOR_COMMUNITIES_LIST"
  const val KEY_USE_COMMUNITY_DOWNLOAD_FOLDER = "KEY_USE_COMMUNITY_DOWNLOAD_FOLDER"

  const val KEY_USE_BUNDLED_AVIF_DECODER = "KEY_USE_BUNDLED_AVIF_DECODER"
  const val KEY_INLINE_IMAGE_MAX_HEIGHT = "KEY_INLINE_IMAGE_MAX_HEIGHT"
  const val KEY_PEEK_IMAGES_ON_LONG_PRESS = "KEY_PEEK_IMAGES_ON_LONG_PRESS"
  const val KEY_PARSE_TAGS_FROM_POST_TITLES = "KEY_PARSE_TAGS_FROM_POST_TITLES"
  const val KEY_GENERATE_MISSING_VIDEO_THUMBNAILS = "KEY_GENERATE_MISSING_VIDEO_THUMBNAILS"

  const val KEY_POSTS_FEED_HEADER_VERSION = "KEY_POSTS_FEED_HEADER_VERSION"
  const val KEY_SHOW_PER_USER_SCORES = "KEY_SHOW_PER_USER_SCORES"
  const val KEY_USE_LEMMY_V4 = "KEY_USE_LEMMY_V4"
  const val KEY_SHOW_FAILED_ACTIONS_BADGE = "KEY_SHOW_FAILED_ACTIONS_BADGE"
  const val KEY_DEFAULT_LANGUAGE_ID = "KEY_DEFAULT_LANGUAGE_ID"

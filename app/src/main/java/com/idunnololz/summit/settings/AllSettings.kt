...
class MiscSettings @Inject constructor(
  ...
  val useCursorsWhenLoadingPostFeed = OnOffSettingItem(
  ...
  val parseTagsFromPostTitles = OnOffSettingItem(
...
class DownloadSettings @Inject constructor(
  ...
  val useCommunityDownloadFolder = OnOffSettingItem(
    title = context.getString(R.string.use_community_download_folder),
    description = context.getString(R.string.use_community_download_folder_desc),
    relatedKeys = listOf(KEY_USE_COMMUNITY_DOWNLOAD_FOLDER),
  )

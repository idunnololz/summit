...
| **imageProxyBypassDomains** | **kotlin.String** |  |  [optional] |
| **imageMode** | [**ImageMode**](ImageMode.md) |  |  [optional] |
| **suggestedMultiCommunityId** | **kotlin.Double** |  |  [optional] |
| **emailNotificationsDisabled** | **kotlin.Boolean** |  |  [optional] |
| **nsfwContentDisallowed** | **kotlin.Boolean** |  |  [optional] |
...
| **federationSignedFetch** | **kotlin.Boolean** |  |  [optional] |
| **reportsEmailAdmins** | **kotlin.Boolean** |  |  [optional] |
| **contentWarning** | **kotlin.String** |  |  [optional] |
| **oauthRegistration** | **kotlin.Boolean** |  |  [optional] |
| **registrationMode** | [**RegistrationMode**](RegistrationMode.md) |  |  [optional] |
| **federationEnabled** | **kotlin.Boolean** |  |  [optional] |
| **rateLimitImportUserSettingsIntervalSeconds** | **kotlin.Double** |  |  [optional] |
| **rateLimitImportUserSettingsMaxRequests** | **kotlin.Double** |  |  [optional] |
| **rateLimitSearchIntervalSeconds** | **kotlin.Double** |  |  [optional] |
| **rateLimitSearchMaxRequests** | **kotlin.Double** |  |  [optional] |
| **rateLimitCommentIntervalSeconds** | **kotlin.Double** |  |  [optional] |
| **rateLimitCommentMaxRequests** | **kotlin.Double** |  |  [optional] |
| **rateLimitImageIntervalSeconds** | **kotlin.Double** |  |  [optional] |
| **rateLimitImageMaxRequests** | **kotlin.Double** |  |  [optional] |
| **rateLimitRegisterIntervalSeconds** | **kotlin.Double** |  |  [optional] |
| **rateLimitRegisterMaxRequests** | **kotlin.Double** |  |  [optional] |
| **rateLimitPostIntervalSeconds** | **kotlin.Double** |  |  [optional] |
| **rateLimitPostMaxRequests** | **kotlin.Double** |  |  [optional] |
| **rateLimitMessageIntervalSeconds** | **kotlin.Double** |  |  [optional] |
| **rateLimitMessageMaxRequests** | **kotlin.Double** |  |  [optional] |
| **slurFilterRegex** | **kotlin.String** |  |  [optional] |
| **discussionLanguages** | **kotlin.collections.List&lt;kotlin.Double&gt;** |  |  [optional] |
| **applicationEmailAdmins** | **kotlin.Boolean** |  |  [optional] |
| **legalInformation** | **kotlin.String** |  |  [optional] |
| **defaultCommentSortType** | [**CommentSortType**](CommentSortType.md) |  |  [optional] |
| **defaultItemsPerPage** | **kotlin.Double** |  |  [optional] |
| **defaultPostTimeRangeSeconds** | **kotlin.Double** |  |  [optional] |
...
| **defaultTheme** | **kotlin.String** |  |  [optional] |
| **privateInstance** | **kotlin.Boolean** |  |  [optional] |
| **applicationQuestion** | **kotlin.String** |  |  [optional] |
| **emailVerificationRequired** | **kotlin.Boolean** |  |  [optional] |
| **communityCreationAdminOnly** | **kotlin.Boolean** |  |  [optional] |
| **summary** | **kotlin.String** |  |  [optional] |
| **sidebar** | **kotlin.String** |  |  [optional] |

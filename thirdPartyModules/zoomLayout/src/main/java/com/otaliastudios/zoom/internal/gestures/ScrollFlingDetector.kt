...
internal class ScrollFlingDetector(
    ...
    override fun onFling(
        ...
        @ZoomApi.ScaledPan val overScrollX = if (panManager.horizontalOverPanEnabled) {
            panManager.maxHorizontalOverPan
        } else {
            0F
        }

        @ZoomApi.ScaledPan val overScrollY = if (panManager.verticalOverPanEnabled) {
            panManager.maxVerticalOverPan
        } else {
            0F
        }
        flingScroller.fling(

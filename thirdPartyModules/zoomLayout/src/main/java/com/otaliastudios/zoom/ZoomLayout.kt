...
open class ZoomLayout private constructor(
  ...
  init {
    ...
    val oneFingerScrollEnabled = a.getBoolean(
      R.styleable.ZoomEngine_oneFingerScrollEnabled,
      true,
    )
    val twoFingersScrollEnabled = a.getBoolean(
      R.styleable.ZoomEngine_twoFingersScrollEnabled,
      true,
    )
    val threeFingersScrollEnabled = a.getBoolean(
      R.styleable.ZoomEngine_threeFingersScrollEnabled,
      true,
    )
    val allowFlingInOverscroll = a.getBoolean(
      R.styleable.ZoomEngine_allowFlingInOverscroll,
      true,
    )
    ...
    @ZoomType val minZoomMode = a.getInteger(
      R.styleable.ZoomEngine_minZoomType,
      ZoomApi.MIN_ZOOM_DEFAULT_TYPE,
    )

    @ZoomType val maxZoomMode = a.getInteger(
